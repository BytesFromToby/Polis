...
def run_cycle(
    ...
    from ..special import (process_the_public, process_moneylender, process_external_threats,
                           process_mayor_removal, process_population, process_election, process_coup)
    ...
    if mayor is not None:
        ...
        # The coup — the great houses' mid-term conspiracy (a risk roll, not a countdown).
        all_results.extend(process_coup(world, mayor, factions, balance=balance))
