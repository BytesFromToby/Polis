...
| `engine/needs/` | Public needs — `bands`, `drift`, `scales` (piety/unrest/consumption/confidence, the production wire) per public-needs_spec; `chain` (the food chains, `compute_chain`) per food-supply_spec |
