...
| 1 | 5 | `CONSUMPTION_PARITY` tuned **0.18 → 0.10** after measuring the standard city's `wine_happy/demand ≈ 0.097`. | The first guess put the std city in Sober; 0.10 lands it in **Tempered (48)**, as the spec requires. Empirical tune, constants-are-provisional. |
